...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container2").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:35*100,width:320,height:240,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:true,logo:"engine2/loading.gif",images:0});