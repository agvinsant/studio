...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container5").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:37*100,width:320,height:240,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:true,logo:"engine5/loading.gif",images:0});