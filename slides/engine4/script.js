...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container4").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:40*100,width:300,height:300,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:false,logo:"engine4/loading.gif",images:0});