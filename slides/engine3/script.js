...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container3").wowSlider({effect:"blinds",prev:"",next:"",duration:20*100,delay:44*100,width:320,height:240,autoPlay:true,stopOnHover:false,loop:false,bullets:true,caption:false,captionEffect:"slide",controls:false,logo:"engine3/loading.gif",images:0});